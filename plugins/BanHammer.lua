--Begin BanHammer.lua By @Ali_k_1999
...
data[tostring(chat)]['is_silent_users'][tostring(matches[2])] = ""
 ...
 if matches[1] == "unsilent" and is_mod(msg) or  matches[1] == "Unsilent" and is_mod(msg) or  matches[1] == "خارج از سکوت" and is_mod(msg) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
