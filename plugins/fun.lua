...
--Begin Fun.lua By @Javid_Team
--Special Thx To @Ali_K_1999
--------------------------------
...
--------------------------------
 ...
 local text = matches[2]
  ...
  local file = download_to_file(url,'TeleJavid.mp3')
 				tdcli.sendDocument(msg.to.id, 0, 0, 1, nil, file, msg_caption, dl_cb, nil)
   end
end
...
if not lang then
helpfun_en = [[
_TeleJavid Fun Help Commands:_
