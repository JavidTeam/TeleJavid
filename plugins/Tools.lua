--Begin Tools.lua :)
local SUDO = 372397769 -- put Your ID here! <===
...
if matches[1] == 'javid' or matches[1] == 'جاوید' or matches[1] == 'Javid' then
